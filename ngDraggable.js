    ...
    .directive('ngDrag', ['$rootScope', '$parse', '$document', '$window', 'ngDraggable', function ($rootScope, $parse, $document, $window, ngDraggable) {
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                // init the start drag offset
                var _startDragOffset = { offset: 0, started: false };

                _startDragOffset.offset = parseInt(attrs.ngDragOffset) || 0;
                ...
                var onmove = function (evt) {
                    ...
                    if (_startDragOffset.offset !== 0 && (!_startDragOffset.started && (_startDragOffset.offset > Math.abs(_tx) || _startDragOffset.offset > Math.abs(_ty)))) return;


                    _startDragOffset.started = true;
                ...
                var onrelease = function (evt) {
                    ...
                    _startDragOffset.started = false;
