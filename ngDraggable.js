...
angular.module("ngDraggable", [])
        .service('ngDraggable', [function() {
            ...
            scope.releaseEvent = function(event) {
                return angular.isDefined(event.originalEvent.changedTouches) ? event.originalEvent.changedTouches[0] : event;
            };
            ...
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    var onrelease = function(evt) {
                        ...
                        $rootScope.$broadcast('draggable:end', {x:_mx, y:_my, tx:_tx, ty:_ty, event:ngDraggable.releaseEvent(evt), element:element, data:_data, /*callback:onDragComplete,*/ uid: _myid});
                        ...
                        ngDraggable.releaseEvent(evt).preventDefault();
                    };
